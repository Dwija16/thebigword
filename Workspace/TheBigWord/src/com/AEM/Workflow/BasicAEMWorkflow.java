...
public class BasicAEMWorkflow {
	...
	public static void main(String [] args) throws Exception{
		...
		driver.findElement(By.xpath("//*[@id='coral-id-18']")).sendKeys("Test_Proj_3110_1302");
		...
		driver.findElement(By.xpath("//coral-card-title[contains(text(),'Test_Proj_3110_1156')]")).click();
